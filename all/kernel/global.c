...
PUBLIC  struct proc *proc_queue[3][NR_TASKS + NR_PROCS + 1];
PUBLIC  int         queue_head[3] = {0, 0, 0};
PUBLIC  int         queue_tail[3] = {0, 0, 0};
...
PUBLIC struct check check_table[NUM_CHECKFILES];
